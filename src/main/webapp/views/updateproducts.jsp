            ...
            <div class="col-sm-5">
                ...
                <div class="form-group">
                    <c:forEach var="product" items="${products}">
                        ...
                        <input type="number"  class="form-control border border-warning" name="id"  value="${product.id} ">
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control border border-warning" required name="price" min="1" placeholder="Price" value="">
                </div>
                <div class="form-group">
